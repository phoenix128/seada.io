...
describe('moveBefore', () => {
    it('should move a component before the specified reference component at the root level', () => {
        ...
        const action: IPageComponentManipulationAction = {
            action: EPageComponentManipulationType.MOVE_BEFORE,
            componentId: '3',
            refComponentId: '1',
        };

        const result = moveBefore(components, action);
    ...
    it('should move a component before the specified reference component in nested components', () => {
        const components: IPageComponentDefinition[] = [
            {
                id: '1',
                label: 'Component 1',
