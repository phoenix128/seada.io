...
import { QUERY_PRODUCT } from '@seada.io/bigcommerce/gql/queries/query-product';
...
export interface IProductCardDataProviderInputProps {
    productKey: string;
}

const productCard: IDataProvider<IProductCardDataProviderResult> = (
    component: IPageComponentDefinition<IProductCardDataProviderInputProps>,
    pageData: IPageData,
    ...
    return {
        operationId: `bigcommerce-product-card:${sku}`,
